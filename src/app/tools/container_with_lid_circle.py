...
def container(
    ...
    for edge in offset_wire.edges():
        ...
        # TODO: fix shpere creation, revlove creates seam causing union problems
        arc = (
            cq.Workplane(plane)
            .moveTo(0, -b)
        ...
        ellip_edge = (
            arc.revolve(360, (0, 0, 0), (0, 1, 0))
            .rotateAboutCenter((0, 0, 1), 90)
            .translate(-plane.yDir * ledge / 2.0)
        )
